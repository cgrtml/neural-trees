...
cross-validation the exact construction loses 19.6 accuracy
points on Iris, 19.1 on Wine and 55.6 on
Digits against the same depth trained from scratch. The fix is a small random
perturbation of the children; its size barely matters. The practical rule is
...
Every number in the paper is inserted from the measurement script's output.
\end{abstract}
